 ...
 * Backend returns either UUID (public_id) or numeric string (session_uid); both refer to the same session.
...
/** Return true if the value looks like a session UUID (use for URLs and API calls). */
