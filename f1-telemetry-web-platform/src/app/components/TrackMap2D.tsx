...
export function TrackMap2D({ layout, cars }: Props) {
  ...
  return (
    <div className="relative w-full h-full">
      <div className="absolute top-4 left-4 z-10 bg-card/60 backdrop-blur-md border border-border/40 rounded-lg p-3">
        ...
        <input
          ...
          className="w-32"
        />
        <div className="text-xs text-center mt-1 font-mono font-bold">
          {zoom.toFixed(1)}×
        </div>
      </div>
