...
**Статус:** реалізовано (етапи 1–5 виконані). Гілка: `feature/03-session-page-display-name`.
...
- [x] **Етап 1** — sessionDisplayName бекенд  
- [x] **Етап 2** — sessionDisplayName фронт  
- [x] **Етап 3** — місце на фініші бекенд  
- [x] **Етап 4** — місце на фініші фронт  
- [x] **Етап 5** — документація та тести  
...
- [x] Перед етапом 1: переконатися, що наступний номер скрипту в `infra/init-db/` відповідає (наприклад 14, 15).
...
**Реалізація завершена:** етапи 1–5 виконані в гілці `feature/03-session-page-display-name` (6 комітів).
